...
class Profile(models.Model):
    ...
    location_one_latitude = models.FloatField(max_length=100, blank=True)
    location_one_longitude = models.FloatField(max_length=100, blank=True)
    location_two_latitude = models.FloatField(max_length=100, blank=True)
    location_two_longitude = models.FloatField(max_length=100, blank=True)
