...
# DEBUG = True
ALLOWED_HOSTS = ['miles-smiles-8a9dbd072758.herokuapp.com', '*']
...
LOGIN_REDIRECT_URL = '/'
WSGI_APPLICATION = 'miles_and_smiles.wsgi.application'
# Database
...
# CSP_DEFAULT_SRC = ("'self'", "stackpath.bootstrapcdn.com", "cdn.jsdelivr.net")
